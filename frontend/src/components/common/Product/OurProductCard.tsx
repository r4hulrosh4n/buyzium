...
const OurProductCard = ({className}: Props) => {
  return (
    <div className={`w-64 flex-shrink-0 ${className}`}>
      <div className="group overflow-hidden relative flex items-center justify-center rounded-md w-64 h-60 bg-secondary">
        ...
        <button className="-bottom-4 opacity-0 transform group-hover:opacity-100 group-hover:bottom-0 ease-in-out duration-300 w-full text-bg bg-button rounded-b-md py-2 absolute">
          Add to cart
        </button>
      </div>
      <div className="mt-4 flex flex-col justify-end space-y-2">
        ...
        <div className="flex space-x-4 items-center">
          <p className="text-secondary2 font-medium text-center">$120</p>
